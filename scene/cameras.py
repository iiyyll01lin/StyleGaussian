...
from scene.VGG import normalize_vgg
...
class Camera(nn.Module):
    ...
    def extract_vgg_features(self, vgg_encoder):
        vgg_input = self.original_image.unsqueeze(0) # [1, 3, H, W]
        vgg_input = normalize_vgg(vgg_input)
        self.vgg_features = vgg_encoder(self.original_image).relu3_1.squeeze(0) # [256, H, W]
